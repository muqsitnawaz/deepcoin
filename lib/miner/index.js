...
class Miner {
    ...
    newMineRequest(reqblock, taskId, nodeId, totalNodes) {
        console.log('Need to train neural network for task ' + taskId)

        // exec(datafetch.py, [nodeId, totalNodes, taskId])


        // const trainpy = execFile('python3', ['scripts/test.py'], (error, stdout, stderr) => {
        //     if (error) {
        //         throw error;
        //     }
    ...
    incrTaskID() {
        ...
        // fs.readdir(this.taskDir, function(err, items) {
        //     console.log(items);
        //     this.taskId  = this.taskId + 1;
        //     if (this.taskId > items.length) {
        //         this.taskId = 1;
        //     }
        // });
    }
