...
class Miner {
    ...
    mine(rewardAddress, feeAddress) {
        ...
        this.blockchain.emitter.emit('newMineRequest', baseBlock);
    ...
    static proveWorkFor(jsonBlock, difficulty) {
        ...
        console.log('Traing data')
        console.log('Wait for averaging and the winner')
        console.log('Whoever won the thing gets the reward')
