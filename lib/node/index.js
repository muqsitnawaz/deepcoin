...
class Node {
    ...
    hookBlockchain() {
        ...
        this.blockchain.emitter.on('newMineRequest', (jsonBlock, taskId) => {
            this.broadcast(this.sendMineRequest, jsonBlock, taskId);
        });
    }
